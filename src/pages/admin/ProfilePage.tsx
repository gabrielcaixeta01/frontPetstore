  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-6 sm:px-6 sm:py-8">
      <div className="space-y-5">
        ...
        {/* ── Dados Pessoais ─────────────────────────────── */}
        <SectionCard iconBg="bg-[#e6f5f5]" iconCls="text-[#0D7377]" IconEl={User} title="Dados Pessoais" sub="Informações cadastrais do administrador">
          {isEditing ? (
        ...
        {/* ── Loja Vinculada ─────────────────────────────── */}
        {lojaName && (
          <SectionCard iconBg="bg-[#e6f5f0]" iconCls="text-[#10B981]" IconEl={Building2} title="Loja Vinculada" sub="Unidade de trabalho">
            <div className="grid divide-gray-100 sm:grid-cols-3 sm:divide-x">
