    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-extrabold text-white">
              Pets <span style={{ color: AMBER }}>Cadastrados</span>
            </h1>
          </div>
          <p className="mt-1 text-sm text-white/70">Gerencie todos os pets cadastrados no sistema</p>
          {!loading && (
      ...
      {loading ? (
        ...
        <div className="p-14 text-center" style={{ border: `1px dashed ${BORD}`, borderRadius: "10px", background: "#fff" }}>
          ...
          <p className="text-sm" style={{ color: MUTED }}>{pets.length === 0 ? "Nenhum pet cadastrado no sistema." : "Nenhum pet encontrado."}</p>
          {pets.length === 0 && (
