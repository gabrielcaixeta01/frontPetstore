    ...
    <div style={{ background: BG, fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif" }}>
      ...
      <section className="px-6 py-16" style={{ background: "#fff" }}>
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 text-center">
            ...
            <p className="mt-2 text-sm" style={{ color: MUTED }}>Mais de 500 petshops já confiam no Pet Club para gerenciar seu negócio.</p>
          </div>
      ...
      <footer className="flex flex-wrap items-center justify-between gap-4 px-6 py-5"
        ...
        <div className="flex items-center gap-2">
          <img src="/logo_apex.png" alt="Pet Club" className="h-7 w-auto" style={{ filter: "brightness(0) invert(1)" }} />
        </div>
