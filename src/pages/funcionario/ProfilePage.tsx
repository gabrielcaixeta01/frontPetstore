  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-6 sm:px-6 sm:py-8">
      <div className="space-y-5">
        ...
        {/* ── Dados Pessoais ─────────────────────────────── */}
        <SectionCard iconBg="bg-[#e8eeff]" iconCls="text-[#1c46f3]" IconEl={User} title="Dados Pessoais" sub="Informações cadastrais do funcionário">
          {isEditing ? (
        ...
        {/* ── Loja Vinculada ─────────────────────────────── */}
        {lojaName && (
          <SectionCard iconBg="bg-[#e6f4ed]" iconCls="text-[#00A651]" IconEl={Building2} title="Loja Vinculada" sub="Unidade de trabalho do funcionário">
            <div className="grid sm:grid-cols-3 sm:divide-x divide-gray-100">
